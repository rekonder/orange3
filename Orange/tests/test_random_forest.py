...
class RandomForestTest(unittest.TestCase):
    ...
    def test_predict_table(self):
        self.modelClassification(self.iris)
        vals, probs = self.modelClassification(self.iris, self.modelClassification.ValueProbs)

    def test_predict_numpy(self):
        self.modelClassification(self.iris.X)
        vals, probs = self.modelClassification(self.iris.X, self.modelClassification.ValueProbs)
